...
const getCursoById = async (req, res) => {
    ...
    try {
        ...
        const curso = await Curso.findOne({
            where: {
                id: cursoId,
                estado: 1, // Asegura que el curso esté activo
            },
        });
        ...
        if (curso) {
            ...
            if (multimediaInfo) {
                ...
                const cursoFormateado = {
                    ...
                    requisitosEquipo: curso.requisitosEquipo, // Analiza la cadena JSON
        ...
        console.error(`Error al obtener el curso por ID ${cursoId}:`, error);
        res.status(500).json({ error: 'Error en el servidor' });
    }
};
...
const postCurso = async (req = request, res = response) => {
    ...
    try {
        ...
        const opcionesDeCompresión = {
            ...
            quality: 60, // Ajusta la calidad de compresión (0-100)
